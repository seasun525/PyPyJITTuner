...
def main(num):
    output_path = '../results/scenario_'+str(num)+'_diff'+'.csv'
    configs = ['110101011000100111', '001001010101011111', '110100011011101101', '111010001001111010']
    configs = ['110101011000100111']
    func_diff = json.load(open('../results/cProfile_diff_ind.json', 'r'))
    ranked_cprofile_funcs = json.load(open('/home/seasun/JIT_unfriendly_func/cProfile_results_all/011011011011011011/cProfile.json', 'r'))
    ranked2 = json.load(open('/home/seasun/JIT_unfriendly_func/cProfile_results_all/110101011000100111/cProfile_no_rank.json', 'r'))
    ...
    result = []
    for func in ranked_cprofile_funcs:
        key = func['key']
#        print key
