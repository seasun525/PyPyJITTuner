...
individual_list <- c('div_individual_value0','div_individual_value1','div_individual_value2','div_individual_value3','div_individual_value4','div_individual_value5','div_individual_value6','div_individual_value7','div_individual_value8')
...
for(i in 1:obj_num){
  ...
  temp_matrix[ind_num+1, ]<-c(0,0,0,0,0,0,0,0,0)
